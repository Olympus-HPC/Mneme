...
// CHECK-RR:BlockDims:(1, 448, 1)
// CHECK-RR:GridDims:(1, 14, 1)
// CHECK-RR:BlockDims:(1, 224, 1)
// CHECK-RR:GridDims:(1, 7, 1)
// CHECK-RR:BlockDims:(1, 480, 1)
// CHECK-RR:GridDims:(1, 15, 1)
// CHECK-RR:BlockDims:(1, 576, 1)
// CHECK-RR:GridDims:(1, 18, 1)
// CHECK-RR:BlockDims:(1, 960, 1)
// CHECK-RR:GridDims:(1, 30, 1)
// CHECK-RR:BlockDims:(1, 32, 1)
// CHECK-RR:GridDims:(1, 1, 1)
// CHECK-RR:BlockDims:(1, 384, 1)
// CHECK-RR:GridDims:(1, 12, 1)
// CHECK-RR:BlockDims:(1, 800, 1)
// CHECK-RR:GridDims:(1, 25, 1)
// CHECK-RR:BlockDims:(1, 832, 1)
// CHECK-RR:GridDims:(1, 26, 1)
// CHECK-RR:BlockDims:(1, 128, 1)
// CHECK-RR:GridDims:(1, 4, 1)
// CHECK-RR:BlockDims:(1, 928, 1)
// CHECK-RR:GridDims:(1, 29, 1)
// CHECK-RR:BlockDims:(1, 1024, 1)
// CHECK-RR:GridDims:(1, 32, 1)
// CHECK-RR:BlockDims:(1, 512, 1)
// CHECK-RR:GridDims:(1, 16, 1)
// CHECK-RR:BlockDims:(1, 544, 1)
// CHECK-RR:GridDims:(1, 17, 1)
// CHECK-RR:BlockDims:(1, 320, 1)
// CHECK-RR:GridDims:(1, 10, 1)
// CHECK-RR:BlockDims:(1, 864, 1)
// CHECK-RR:GridDims:(1, 27, 1)
// CHECK-RR:BlockDims:(1, 608, 1)
// CHECK-RR:GridDims:(1, 19, 1)
// CHECK-RR:BlockDims:(1, 416, 1)
// CHECK-RR:GridDims:(1, 13, 1)
// CHECK-RR:BlockDims:(1, 160, 1)
// CHECK-RR:GridDims:(1, 5, 1)
// CHECK-RR:BlockDims:(1, 704, 1)
// CHECK-RR:GridDims:(1, 22, 1)
// CHECK-RR:BlockDims:(1, 736, 1)
// CHECK-RR:GridDims:(1, 23, 1)
// CHECK-RR:BlockDims:(1, 640, 1)
// CHECK-RR:GridDims:(1, 20, 1)
// CHECK-RR:BlockDims:(1, 992, 1)
// CHECK-RR:GridDims:(1, 31, 1)
// CHECK-RR:BlockDims:(1, 352, 1)
// CHECK-RR:GridDims:(1, 11, 1)
// CHECK-RR:BlockDims:(1, 896, 1)
// CHECK-RR:GridDims:(1, 28, 1)
// CHECK-RR:BlockDims:(1, 64, 1)
// CHECK-RR:GridDims:(1, 2, 1)
// CHECK-RR:BlockDims:(1, 288, 1)
// CHECK-RR:GridDims:(1, 9, 1)
// CHECK-RR:BlockDims:(1, 96, 1)
// CHECK-RR:GridDims:(1, 3, 1)
// CHECK-RR:BlockDims:(1, 768, 1)
// CHECK-RR:GridDims:(1, 24, 1)
// CHECK-RR:BlockDims:(1, 672, 1)
// CHECK-RR:GridDims:(1, 21, 1)
// CHECK-RR:BlockDims:(1, 256, 1)
// CHECK-RR:GridDims:(1, 8, 1)
// CHECK-RR:BlockDims:(1, 192, 1)
// CHECK-RR:GridDims:(1, 6, 1)
