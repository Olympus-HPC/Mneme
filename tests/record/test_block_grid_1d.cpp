...
// RUN: rm -rf "%t.$$.mneme" && mkdir -p "%t.$$.mneme"
// RUN: MNEME_CAPTURE_MODE=reachable MNEME_MAX_RECORDINGS=100 LD_PRELOAD=MNEME_PRELOAD_LIB MNEME_LOG_LEVEL=debug MNEME_PAGE_SIZE=%PG MNEME_DATA_DIR="%t.$$.mneme" %build/test_block_grid_1d%ext | %FILECHECK %s --check-prefixes=CHECK
// RUN: %RR "%t.$$.mneme" | %FILECHECK %s --check-prefix=CHECK-RR
// RUN: rm -rf "%t.$$.mneme"
// clang-format on
...
// CHECK-RR-DAG:BlockDims:(992, 1, 1)
// CHECK-RR-DAG:GridDims:(31, 1, 1)
// CHECK-RR-DAG:BlockDims:(576, 1, 1)
// CHECK-RR-DAG:GridDims:(18, 1, 1)
// CHECK-RR-DAG:BlockDims:(224, 1, 1)
// CHECK-RR-DAG:GridDims:(7, 1, 1)
// CHECK-RR-DAG:BlockDims:(96, 1, 1)
// CHECK-RR-DAG:GridDims:(3, 1, 1)
// CHECK-RR-DAG:BlockDims:(256, 1, 1)
// CHECK-RR-DAG:GridDims:(8, 1, 1)
// CHECK-RR-DAG:BlockDims:(448, 1, 1)
// CHECK-RR-DAG:GridDims:(14, 1, 1)
// CHECK-RR-DAG:BlockDims:(352, 1, 1)
// CHECK-RR-DAG:GridDims:(11, 1, 1)
// CHECK-RR-DAG:BlockDims:(544, 1, 1)
// CHECK-RR-DAG:GridDims:(17, 1, 1)
// CHECK-RR-DAG:BlockDims:(192, 1, 1)
// CHECK-RR-DAG:GridDims:(6, 1, 1)
// CHECK-RR-DAG:BlockDims:(64, 1, 1)
// CHECK-RR-DAG:GridDims:(2, 1, 1)
// CHECK-RR-DAG:BlockDims:(32, 1, 1)
// CHECK-RR-DAG:GridDims:(1, 1, 1)
// CHECK-RR-DAG:BlockDims:(704, 1, 1)
// CHECK-RR-DAG:GridDims:(22, 1, 1)
// CHECK-RR-DAG:BlockDims:(832, 1, 1)
// CHECK-RR-DAG:GridDims:(26, 1, 1)
// CHECK-RR-DAG:BlockDims:(1024, 1, 1)
// CHECK-RR-DAG:GridDims:(32, 1, 1)
// CHECK-RR-DAG:BlockDims:(896, 1, 1)
// CHECK-RR-DAG:GridDims:(28, 1, 1)
// CHECK-RR-DAG:BlockDims:(512, 1, 1)
// CHECK-RR-DAG:GridDims:(16, 1, 1)
// CHECK-RR-DAG:BlockDims:(480, 1, 1)
// CHECK-RR-DAG:GridDims:(15, 1, 1)
// CHECK-RR-DAG:BlockDims:(288, 1, 1)
// CHECK-RR-DAG:GridDims:(9, 1, 1)
// CHECK-RR-DAG:BlockDims:(672, 1, 1)
// CHECK-RR-DAG:GridDims:(21, 1, 1)
// CHECK-RR-DAG:BlockDims:(640, 1, 1)
// CHECK-RR-DAG:GridDims:(20, 1, 1)
// CHECK-RR-DAG:BlockDims:(928, 1, 1)
// CHECK-RR-DAG:GridDims:(29, 1, 1)
// CHECK-RR-DAG:BlockDims:(768, 1, 1)
// CHECK-RR-DAG:GridDims:(24, 1, 1)
// CHECK-RR-DAG:BlockDims:(864, 1, 1)
// CHECK-RR-DAG:GridDims:(27, 1, 1)
// CHECK-RR-DAG:BlockDims:(160, 1, 1)
// CHECK-RR-DAG:GridDims:(5, 1, 1)
// CHECK-RR-DAG:BlockDims:(320, 1, 1)
// CHECK-RR-DAG:GridDims:(10, 1, 1)
// CHECK-RR-DAG:BlockDims:(800, 1, 1)
// CHECK-RR-DAG:GridDims:(25, 1, 1)
// CHECK-RR-DAG:BlockDims:(416, 1, 1)
// CHECK-RR-DAG:GridDims:(13, 1, 1)
// CHECK-RR-DAG:BlockDims:(736, 1, 1)
// CHECK-RR-DAG:GridDims:(23, 1, 1)
// CHECK-RR-DAG:BlockDims:(128, 1, 1)
// CHECK-RR-DAG:GridDims:(4, 1, 1)
// CHECK-RR-DAG:BlockDims:(384, 1, 1)
// CHECK-RR-DAG:GridDims:(12, 1, 1)
// CHECK-RR-DAG:BlockDims:(608, 1, 1)
// CHECK-RR-DAG:GridDims:(19, 1, 1)
// CHECK-RR-DAG:BlockDims:(960, 1, 1)
// CHECK-RR-DAG:GridDims:(30, 1, 1)
