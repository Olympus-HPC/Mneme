...
// CHECK-RR:BlockDims:(992, 1, 1)
// CHECK-RR:GridDims:(31, 1, 1)
// CHECK-RR:BlockDims:(576, 1, 1)
// CHECK-RR:GridDims:(18, 1, 1)
// CHECK-RR:BlockDims:(224, 1, 1)
// CHECK-RR:GridDims:(7, 1, 1)
// CHECK-RR:BlockDims:(96, 1, 1)
// CHECK-RR:GridDims:(3, 1, 1)
// CHECK-RR:BlockDims:(256, 1, 1)
// CHECK-RR:GridDims:(8, 1, 1)
// CHECK-RR:BlockDims:(448, 1, 1)
// CHECK-RR:GridDims:(14, 1, 1)
// CHECK-RR:BlockDims:(352, 1, 1)
// CHECK-RR:GridDims:(11, 1, 1)
// CHECK-RR:BlockDims:(544, 1, 1)
// CHECK-RR:GridDims:(17, 1, 1)
// CHECK-RR:BlockDims:(192, 1, 1)
// CHECK-RR:GridDims:(6, 1, 1)
// CHECK-RR:BlockDims:(64, 1, 1)
// CHECK-RR:GridDims:(2, 1, 1)
// CHECK-RR:BlockDims:(32, 1, 1)
// CHECK-RR:GridDims:(1, 1, 1)
// CHECK-RR:BlockDims:(704, 1, 1)
// CHECK-RR:GridDims:(22, 1, 1)
// CHECK-RR:BlockDims:(832, 1, 1)
// CHECK-RR:GridDims:(26, 1, 1)
// CHECK-RR:BlockDims:(1024, 1, 1)
// CHECK-RR:GridDims:(32, 1, 1)
// CHECK-RR:BlockDims:(896, 1, 1)
// CHECK-RR:GridDims:(28, 1, 1)
// CHECK-RR:BlockDims:(512, 1, 1)
// CHECK-RR:GridDims:(16, 1, 1)
// CHECK-RR:BlockDims:(480, 1, 1)
// CHECK-RR:GridDims:(15, 1, 1)
// CHECK-RR:BlockDims:(288, 1, 1)
// CHECK-RR:GridDims:(9, 1, 1)
// CHECK-RR:BlockDims:(672, 1, 1)
// CHECK-RR:GridDims:(21, 1, 1)
// CHECK-RR:BlockDims:(640, 1, 1)
// CHECK-RR:GridDims:(20, 1, 1)
// CHECK-RR:BlockDims:(928, 1, 1)
// CHECK-RR:GridDims:(29, 1, 1)
// CHECK-RR:BlockDims:(768, 1, 1)
// CHECK-RR:GridDims:(24, 1, 1)
// CHECK-RR:BlockDims:(864, 1, 1)
// CHECK-RR:GridDims:(27, 1, 1)
// CHECK-RR:BlockDims:(160, 1, 1)
// CHECK-RR:GridDims:(5, 1, 1)
// CHECK-RR:BlockDims:(320, 1, 1)
// CHECK-RR:GridDims:(10, 1, 1)
// CHECK-RR:BlockDims:(800, 1, 1)
// CHECK-RR:GridDims:(25, 1, 1)
// CHECK-RR:BlockDims:(416, 1, 1)
// CHECK-RR:GridDims:(13, 1, 1)
// CHECK-RR:BlockDims:(736, 1, 1)
// CHECK-RR:GridDims:(23, 1, 1)
// CHECK-RR:BlockDims:(128, 1, 1)
// CHECK-RR:GridDims:(4, 1, 1)
// CHECK-RR:BlockDims:(384, 1, 1)
// CHECK-RR:GridDims:(12, 1, 1)
// CHECK-RR:BlockDims:(608, 1, 1)
// CHECK-RR:GridDims:(19, 1, 1)
// CHECK-RR:BlockDims:(960, 1, 1)
// CHECK-RR:GridDims:(30, 1, 1)
